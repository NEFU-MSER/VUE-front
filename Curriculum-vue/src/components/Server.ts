...
//         const tempLib = schema.db.Libs.findBy({ key: postForm.libId })
//         if (tempLib != null) {
//           const lib: Lib = tempLib.Lib
...
//               if (occ._classTime.length <= 1) {
//                 lib._libOccupations.splice(index, 1)
//               } else {
//                 //只删除对应时间段
//                 occ._classTime.splice(postForm.timeId, 1)
//                 occ._timeDescribe = Occupation.classTimeConvert(occ._classTime)
//               }
//             }
//           }
...
//               //假删除对应时间段
//               occupation.deleteClassTime(data.timeIndex)
//               //尝试添加新的时间段
//               result = tempLib.addOccupation(data.newOccupation)
//               if (result.result) {
//                 //真正删除对应时间段
//                 lib._libOccupations[index].deleteClassTime(data.timeIndex)
//                 //真正添加新的时间段
...
//                 } else {
//                   //只删除对应时间段
//                   occupation._classTime.splice(data.timeIndex, 1)
//                   occupation._timeDescribe = Occupation.classTimeConvert(occupation._classTime)
//                 }
//               }
//             }
